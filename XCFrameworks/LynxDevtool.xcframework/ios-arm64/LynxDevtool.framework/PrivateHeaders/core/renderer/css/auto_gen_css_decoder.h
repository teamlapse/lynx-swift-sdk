...
class AutoGenCSSDecoder {
 public:
  ...
  static std::string ToXPlaceholderFontWeightType(
      lynx::starlight::XPlaceholderFontWeightType type);

  static std::string ToXPlaceholderFontStyleType(
      lynx::starlight::XPlaceholderFontStyleType type);

  static std::string ToPointerEventsType(
      lynx::starlight::PointerEventsType type);
