...
#ifndef CORE_RUNTIME_COMMON_BINDINGS_EVENT_CONTEXT_PROXY_TEST_H_
#define CORE_RUNTIME_COMMON_BINDINGS_EVENT_CONTEXT_PROXY_TEST_H_
...
#endif  // CORE_RUNTIME_COMMON_BINDINGS_EVENT_CONTEXT_PROXY_TEST_H_
