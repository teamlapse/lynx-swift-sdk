...
struct MetaData {
	...
	MetaData(Level level, std::string fix_suggestion, std::vector<Consumer> consumer);
};

std::shared_ptr<MetaData> GetMetaData(int32_t code);
