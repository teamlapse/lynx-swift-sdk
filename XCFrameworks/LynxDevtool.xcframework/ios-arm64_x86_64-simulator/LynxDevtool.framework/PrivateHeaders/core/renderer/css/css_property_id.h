...
#define FOREACH_ALL_PROPERTY(V)                                               \
  ...
  V(XPlaceholderColor, "-x-placeholder-color", "black")                       \
  V(XPlaceholderFontFamily, "-x-placeholder-font-family", "")                 \
  V(XPlaceholderFontSize, "-x-placeholder-font-size", "medium")               \
  V(XPlaceholderFontWeight, "-x-placeholder-font-weight", "normal")           \
  V(XPlaceholderFontStyle, "-x-placeholder-font-style", "normal")             \
  V(PointerEvents, "pointer-events", "auto")
