...
namespace tasm {
namespace report {
static constexpr const uint32_t kAllFeaturesCount = 89;
...
enum LynxFeature : uint32_t {
  ...
  CPP_CUSTOM_LIST = 35,
  CPP_USE_FRAME_ELEMENT = 36,
  CPP_ENABLE_PARALLEL_FLUSH_FIBER_ARCH = 37,
  CPP_ENABLE_PARALLEL_FLUSH_FIBER_RADON_ARCH = 38,
  CPP_ENABLE_CSS_INHERITANCE = 39,
  CPP_DISABLE_CSS_INHERITANCE = 40,
  CPP_ENABLE_CSS_VARIABLES = 41,
  CPP_DISABLE_CSS_VARIABLES = 42,
  CPP_ENABLE_STANDARD_CSS_SELECTOR = 43,
  CPP_DISABLE_STANDARD_CSS_SELECTOR = 44,
  TYPESCRIPT_BUNDLE_SUPPORT_LOAD_SCRIPT = 45,
  OBJC_IMPLICIT_ANIMATION = 46,
  OBJC_PAGE_RTL = 47,
  OBJC_PAGE_RTL_WITH_LIST = 48,
  OBJC_DISABLE_NEW_TRANSFORM_ORIGIN_IOS = 49,
  OBJC_AUTO_RESUME_ANIMATION = 50,
  OBJC_LAYOUT_ANIMATION_CREATE = 51,
  OBJC_LAYOUT_ANIMATION_UPDATE = 52,
  OBJC_LAYOUT_ANIMATION_DELETE = 53,
  OBJC_ENTER_TRANSITION_NAME = 54,
  OBJC_EXIT_TRANSITION_NAME = 55,
  OBJC_PAUSE_TRANSITION_NAME = 56,
  OBJC_RESUME_TRANSITION_NAME = 57,
  OBJC_UPDATE_FONT_SCALE = 58,
  OBJC_DISABLE_REUSE_ANIMATION_STATE = 59,
  OBJC_LIST_IOS_RECURSIVE_LAYOUT = 60,
  OBJC_LIST_IOS_DISABLE_SCROLL_ANIM_DURING_LAYOUT = 61,
  OBJC_LIST_IOS_USE_SCROLLER = 62,
  OBJC_LIST_PAGING_ENABLE = 63,
  OBJC_DISABLE_TOUCH_REFACTOR = 64,
  OBJC_SET_THEME_IOS = 65,
  OBJC_GET_THEME_IOS = 66,
  OBJC_UI_OWNER_RELEASE_ON_CHILD_THREAD = 67,
  OBJC_ENABLE_ASYNC_LIST = 68,
  OBJC_USE_LEGACY_ELEMENTS = 69,
  JAVA_HARDWARE_LAYER = 70,
  JAVA_NEW_SWIPER_NOT_ENABLED = 71,
  JAVA_LAYOUT_ANIMATION_CREATE_ANDROID = 72,
  JAVA_LAYOUT_ANIMATION_UPDATE_ANDROID = 73,
  JAVA_LAYOUT_ANIMATION_DELETE_ANDROID = 74,
  JAVA_ENTER_TRANSITION_NAME_ANDROID = 75,
  JAVA_EXIT_TRANSITION_NAME_ANDROID = 76,
  JAVA_PAUSE_TRANSITION_NAME_ANDROID = 77,
  JAVA_RESUME_TRANSITION_NAME_ANDROID = 78,
  JAVA_UPDATE_FONT_SCALE = 79,
  JAVA_DISABLE_REUSE_ANIMATION_STATE = 80,
  JAVA_DISABLE_FOLDVIEW_STOP_TOUCH_STOP_FLING = 81,
  JAVA_ASYNC_REDIRECT = 82,
  JAVA_ENABLE_ASYNC_REQUEST_IMAGE = 83,
  JAVA_SET_THEME_ANDROID = 84,
  JAVA_GET_THEME_ANDROID = 85,
  JAVA_ENABLE_ASYNC_LIST = 86,
  JAVA_USE_LEGACY_ELEMENTS = 87,
  JAVA_ENABLE_FONT_SCALING = 88,
};
...
inline const char* LynxFeatureToString(LynxFeature feature) {
  switch (feature) {
    ...
    case CPP_USE_FRAME_ELEMENT: {
      return "cpp_use_frame_element";
    }
    case CPP_ENABLE_PARALLEL_FLUSH_FIBER_ARCH: {
      return "cpp_enable_parallel_flush_fiber_arch";
    }
    case CPP_ENABLE_PARALLEL_FLUSH_FIBER_RADON_ARCH: {
      return "cpp_enable_parallel_flush_fiber_radon_arch";
    }
    case CPP_ENABLE_CSS_INHERITANCE: {
      return "cpp_enable_css_inheritance";
    }
    case CPP_DISABLE_CSS_INHERITANCE: {
      return "cpp_disable_css_inheritance";
    }
    case CPP_ENABLE_CSS_VARIABLES: {
      return "cpp_enable_css_variables";
    }
    case CPP_DISABLE_CSS_VARIABLES: {
      return "cpp_disable_css_variables";
    }
    case CPP_ENABLE_STANDARD_CSS_SELECTOR: {
      return "cpp_enable_standard_css_selector";
    }
    case CPP_DISABLE_STANDARD_CSS_SELECTOR: {
      return "cpp_disable_standard_css_selector";
    }
