...
typedef NS_ENUM(NSUInteger, LynxXPlaceholderFontWeightType) {
  LynxXPlaceholderFontWeightNormal = 0,  // version:3.5
  LynxXPlaceholderFontWeightBold = 1,    // version:3.5
  LynxXPlaceholderFontWeight100 = 2,     // version:3.5
  LynxXPlaceholderFontWeight200 = 3,     // version:3.5
  LynxXPlaceholderFontWeight300 = 4,     // version:3.5
  LynxXPlaceholderFontWeight400 = 5,     // version:3.5
  LynxXPlaceholderFontWeight500 = 6,     // version:3.5
  LynxXPlaceholderFontWeight600 = 7,     // version:3.5
  LynxXPlaceholderFontWeight700 = 8,     // version:3.5
  LynxXPlaceholderFontWeight800 = 9,     // version:3.5
  LynxXPlaceholderFontWeight900 = 10,    // version:3.5
};

typedef NS_ENUM(NSUInteger, LynxXPlaceholderFontStyleType) {
  LynxXPlaceholderFontStyleNormal = 0,   // version:3.5
  LynxXPlaceholderFontStyleItalic = 1,   // version:3.5
  LynxXPlaceholderFontStyleOblique = 2,  // version:3.5
};

typedef NS_ENUM(NSUInteger, LynxPointerEventsType) {
  LynxPointerEventsAuto = 0,  // version:3.5
  LynxPointerEventsNone = 1,  // version:3.5
};
