...
enum class XPlaceholderFontWeightType : uint8_t {
  kNormal = 0,  // version:3.5
  kBold = 1,    // version:3.5
  k100 = 2,     // version:3.5
  k200 = 3,     // version:3.5
  k300 = 4,     // version:3.5
...
enum class XPlaceholderFontStyleType : uint8_t {
  kNormal = 0,   // version:3.5
  kItalic = 1,   // version:3.5
  kOblique = 2,  // version:3.5
};
enum class PointerEventsType : uint8_t {
  kAuto = 0,  // version:3.5
  kNone = 1,  // version:3.5
};
