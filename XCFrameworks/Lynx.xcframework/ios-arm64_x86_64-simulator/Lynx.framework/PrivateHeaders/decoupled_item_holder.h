...
class ItemHolder {
 public:
  ...
  void UpdateLayoutFromItemDelegate(list::ItemElementDelegate* item_delegate);
 ...
 private:
  ...
  void SetItemDelegate(list::ItemElementDelegate* item_delegate) {
 ...
 private:
  ...
  list::ItemElementDelegate* item_delegate_{nullptr};
