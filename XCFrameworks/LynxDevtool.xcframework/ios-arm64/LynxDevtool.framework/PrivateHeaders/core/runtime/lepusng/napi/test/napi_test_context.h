...
// clang-format off
#ifndef CORE_RUNTIME_LEPUSNG_NAPI_TEST_NAPI_TEST_CONTEXT_H_
#define CORE_RUNTIME_LEPUSNG_NAPI_TEST_NAPI_TEST_CONTEXT_H_
...
#endif  // CORE_RUNTIME_LEPUSNG_NAPI_TEST_NAPI_TEST_CONTEXT_H_
